...
├── swiftcompress.xcodeproj/          # Xcode project files (if generated)
...
// Third-party (from Swift Package Manager)
import ArgumentParser  // Apple's Swift Argument Parser
...
**.gitignore**: Exclude build artifacts, SPM build folder, derived data
